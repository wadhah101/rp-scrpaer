...
class TestGetWorkoutsCount200Response(unittest.TestCase):
    """GetWorkoutsCount200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWorkoutsCount200Response:
        """Test GetWorkoutsCount200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetWorkoutsCount200Response`
        """
        model = GetWorkoutsCount200Response()
        if include_optional:
            return GetWorkoutsCount200Response(
                workout_count = 56
            )
        else:
            return GetWorkoutsCount200Response(
    ...
    def testGetWorkoutsCount200Response(self):
        """Test GetWorkoutsCount200Response"""
