...
class TestUpdatedWorkout(unittest.TestCase):
    """UpdatedWorkout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatedWorkout:
        """Test UpdatedWorkout
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdatedWorkout`
        """
        model = UpdatedWorkout()
        if include_optional:
