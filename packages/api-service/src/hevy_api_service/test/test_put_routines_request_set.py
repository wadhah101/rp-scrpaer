...
class TestPutRoutinesRequestSet(unittest.TestCase):
    """PutRoutinesRequestSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutRoutinesRequestSet:
        """Test PutRoutinesRequestSet
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PutRoutinesRequestSet`
        """
        model = PutRoutinesRequestSet()
        if include_optional:
            return PutRoutinesRequestSet(
                type = 'normal',
                weight_kg = 100,
                reps = 10,
                distance_meters = 56,
    ...
    def testPutRoutinesRequestSet(self):
        """Test PutRoutinesRequestSet"""
