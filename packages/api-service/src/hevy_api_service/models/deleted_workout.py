...
class DeletedWorkout(BaseModel):
    ...
    type: StrictStr = Field(description="Indicates the type of the event (deleted)")
    id: StrictStr = Field(description="The unique identifier of the deleted workout")
    deleted_at: StrictStr | None = Field(
        default=None,
        description="A date string indicating when the workout was deleted",
    )
    __properties: ClassVar[list[str]] = ["type", "id", "deleted_at"]
