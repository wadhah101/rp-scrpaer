...
class GetRoutineFolders200Response(BaseModel):
    ...
    routine_folders: list[RoutineFolder] | None = None
    __properties: ClassVar[list[str]] = ["page", "page_count", "routine_folders"]
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.routine_folders:
            for _item_routine_folders in self.routine_folders:
                if _item_routine_folders:
                    _items.append(_item_routine_folders.to_dict())
        ...
        _obj = cls.model_validate(
            {
                ...
                "routine_folders": [
                    RoutineFolder.from_dict(_item) for _item in obj["routine_folders"]
                ]
