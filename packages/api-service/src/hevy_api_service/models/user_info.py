...
class UserInfo(BaseModel):
    ...
    id: StrictStr | None = Field(default=None, description="The user ID.")
    name: StrictStr | None = Field(default=None, description="The user's display name.")
    url: StrictStr | None = Field(
        default=None, description="The user's public profile URL."
    )
