...
class CreateCustomExerciseTemplate400Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of CreateCustomExerciseTemplate400Response from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of CreateCustomExerciseTemplate400Response from a dict"""
        if obj is None:
            return None
