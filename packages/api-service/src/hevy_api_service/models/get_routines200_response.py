...
class GetRoutines200Response(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["page", "page_count", "routines"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "routines": [Routine.from_dict(_item) for _item in obj["routines"]]
                if obj.get("routines") is not None
                else None,
            }
        )
        return _obj
