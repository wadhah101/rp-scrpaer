...
import api_service_rp.models
from api_service_rp import rest
from api_service_rp.api_response import ApiResponse
from api_service_rp.api_response import T as ApiResponseT
from api_service_rp.configuration import Configuration
from api_service_rp.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(api_service_rp.models, klass)
